...
public class App {
	...
	public static void main(String[] args) {
		...
		c1.inscribir(a7);
		c1.inscribir(a8);
		c1.inscribir(a9);//falla por falta de cupo
		c2.inscribir(a1);
		c2.inscribir(a2);
		c2.inscribir(a3);
		c3.inscribir(a1);
		c3.inscribir(a2);
		c3.inscribir(a3);
		c4.inscribir(a1); //falla por ser el 4to curso del mismo ciclo lectivo
		...
		c8.inscribir(a1);
		c8.inscribir(a2);//créditos insuficientes
		c8.inscribir(a3);//créditos insuficientes
